                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.fromLTRB(60, 30, 0, 0),
                          ...
                          Container(
                            ...
                            child: TextFormField(
                                ...
                                initialValue:
                                    widget._userSession.user.firstName,
                                onChanged: (value) {
                                  watch(profileProvider).firstName = value;
                                },
                                textAlign: TextAlign.left,
                          ...
                          Container(
                            ...
                            child: TextFormField(
                                ...
                                onChanged: (value) {
                                  watch(profileProvider).gender = value;
                                },
                                textAlign: TextAlign.left,
                          ...
                          Container(
                            ...
                            child: TextFormField(
                                enabled:
                                    widget.isEditing == false ? false : true,
                                initialValue:
                                    widget._userSession.user.phoneNumber,
                                onChanged: (value) {
                                  watch(profileProvider).phoneNumber = value;
                                },
                                textAlign: TextAlign.left,
                          ...
                          Container(
                            ...
                            child: TextFormField(
                                ...
                                onChanged: (value) {
                                  watch(profileProvider).email = value;
                                },
                                textAlign: TextAlign.left,
                              ...
                              ? Row(
                                  ...
                                  children: [
                                    ...
                                    FloatingActionButton.extended(
                                      ...
                                      foregroundColor: Colors.black,
                                      onPressed: () {
                                        watch(profileProvider).updateProfile();
                                      },
                                      label: Text(
                                        "Save",
